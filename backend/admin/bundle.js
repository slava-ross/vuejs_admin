  ...
  methods: {
    ...
    updatePageList: function updatePageList() {
      ...
      axios.get("./api/").then(function (response) {
        _this2.pageList = response.data;
      });
    },
    deletePage: function deletePage(page) {
      var _this3 = this;

      axios.post("./api/deleteHtmlPage.php", {
        "name": page
      }).then(function () {
        return _this3.updatePageList();
      });
    }
  },
